...
function compute_MMN_oddball(lc::Array{microcircuit}, sim::Dict{String,Float64})
    ...
    fr_frequent = lc[1].list_soma[1].r_save[round(Int,time_frequent/0.0005)]
    fr_oddball = lc[2].list_soma[1].r_save[round(Int,time_oddball/0.0005)]
...
function compute_MMN_time(lc::Array{microcircuit},list_current, sim::Dict{String,Float64})
    ...
    fr_frequent = lc[1].list_soma[1].r_save[round(Int,time_frequent_d/0.0005):round(Int,time_frequent_f/0.0005)]
    fr_oddball = lc[2].list_soma[1].r_save[round(Int,time_oddball_d/0.0005):round(Int,time_oddball_f/0.0005)]
