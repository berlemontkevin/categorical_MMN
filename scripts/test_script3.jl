...
function generate_oddball_tasklc(param::Dict{String,Float64})# f1::Float64, value_stim_f1::Float64; Tinter = 1.0, Tstim = 0.5, Tfin = 60.0, value_stim_f2 = 0.0)
...
lc =  generate_oddball_tasklc(general_args)

lc[1]

@trace sum_input!(lc[1].list_soma[1],1)
@code_warntype sum_input!(lc[1].list_dend[1],1)

@trace sum_input!(lc[1].list_vip[1],1)
@code_warntype sum_input!(lc[1].list_vip[1],1)


@trace current_to_frequency!(lc[1].list_soma[1])
@code_warntype current_to_frequency!(lc[1].list_sst[1])

@trace update_dend!(lc[1].list_dend[1],1)
@code_warntype update_dend!(lc[1].list_dend[1],1)
...
@code_warntype update_firing!(lc[1].list_vip[1])
@trace update_firing!(lc[1].list_vip[1])



@trace update_adaptation!(lc[1].list_soma[1], lc[1].list_soma[1].dt)
@code_warntype update_adaptation!(lc[1].list_soma[1], lc[1].list_soma[1].dt)
...
@code_warntype current_synapses!(lc[1].list_vip[1])
...
@profile sum_input!(lc[1].list_soma[1],1)


Profile.print()

Profile.clear()
@profile(for i=1:10  current_to_frequency!(lc[1].list_soma[1]) end)

Profile.print()

@profile update_firing!(lc[1].list_vip[1])
Profile.print()
...
ProfileView.@profview sum_input!(lc[1].list_soma[1],1)

VSCodeServer.@profview sum_input!(lc[1].list_soma[1],1)

ProfileView.@profview synapse_derivative(lc[1].list_dend[1].list_syn_post_nmda[1])

generate_oddball_task(general_args)
ProfileView.@profview generate_oddball_task(general_args)


VSCodeServer.@profview generate_oddball_task(general_args)



@code_warntype full_time_dynamics()